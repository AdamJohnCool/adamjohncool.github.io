...
@Component({
	...
	template: `
		<div class="education-intro">
			...
			<p>
				Graduated in 2021 with a Bachelor degree in Computer Engineering Co-op studying both
				the software and hardware of computing systems. Studies focused on computer
